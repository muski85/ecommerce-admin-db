        ...
        <table className="w-full min-w-[800px]">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Update</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-200">
            {orders.map(order => (
              <tr key={order.id} className="hover:bg-gray-50">
                <td className="px-4 lg:px-6 py-4 text-sm font-medium text-blue-600">#{order.id}</td>
                <td className="px-4 lg:px-6 py-4 text-sm text-gray-900">{order.customer}</td>
                <td className="px-4 lg:px-6 py-4 text-sm text-gray-600">{order.items}</td>
                <td className="px-4 lg:px-6 py-4 text-sm font-medium text-gray-900">${order.total}</td>
